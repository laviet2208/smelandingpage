        ...
        <div className={`transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="flex gap-2 sm:gap-4 mb-8 sm:mb-12 border-b border-border overflow-x-auto">
            <button
              ...
              className={`px-3 sm:px-6 py-2 sm:py-3 font-semibold text-xs sm:text-sm transition-all duration-300 relative whitespace-nowrap ${activeTab === 'core'
                  ? 'text-primary'
            ...
            <button
              ...
              className={`px-3 sm:px-6 py-2 sm:py-3 font-semibold text-xs sm:text-sm transition-all duration-300 relative whitespace-nowrap ${activeTab === 'emerging'
                  ? 'text-primary'
                  : 'text-muted-foreground hover:text-foreground'
                }`}
            >
