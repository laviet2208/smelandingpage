        ...
        <div className={`transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            <div className="group p-4 sm:p-6 md:p-8 bg-white dark:bg-slate-900 rounded-2xl border border-border hover:border-primary hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground">Leading-edge research and mentorship in model engineering and automated software engineering</p>
            </div>
            ...
            <div className="group p-4 sm:p-6 md:p-8 bg-white dark:bg-slate-900 rounded-2xl border border-border hover:border-primary hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground">Advanced research contributions and project development in cutting-edge areas</p>
            </div>
            ...
            <div className="group p-4 sm:p-6 md:p-8 bg-white dark:bg-slate-900 rounded-2xl border border-border hover:border-primary hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground">PhD, Master&apos;s and undergraduate students working on innovative research projects</p>
            </div>
          </div>
          ...
          <div className="mt-8 sm:mt-12 md:mt-16 p-4 sm:p-6 md:p-8 bg-white dark:bg-slate-900 rounded-2xl border border-border">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              <div>
                <h3 className="text-base sm:text-lg font-bold text-primary mb-3 sm:mb-4">Lab Contact</h3>
                <div className="space-y-2 text-sm sm:text-base">
                  <p className="text-foreground">
                    <span className="font-semibold">Lab Head:</span><br/>
              ...
              <div>
                <h3 className="text-base sm:text-lg font-bold text-primary mb-3 sm:mb-4">Institution</h3>
